...
function ContactForm({Icons,title,text }) {
    return (
        <contactform className="flex flex-col items-center justify-center space-y-20 mb-32 mt-32 px-32">
            {/*title */}
            <div className='flex flex-col items-center space-y-5'>
                <h2 className='text-black text-5xl font-bold text-center leading-tight'>VOUS SOUHAITEZ PARTAGER <br />VOTRE PROJET ?</h2>
                <p className='w-4/6 text-center text-lg text-gray-600 leading-tight'>Fixons un rendez-vous pour en discuter.</p>   
            </div>
            {/*contact form */}
            <div className=''>
